"""
Django settings for soozan_project project.
...
SECRET_KEY = 'django-insecure-2v*2pwvnu%$xxy!t(ut&!cl@_mgg*th02-1nm8=*cv)muno4mj'
...
WSGI_APPLICATION = 'soozan_project.wsgi.application'
